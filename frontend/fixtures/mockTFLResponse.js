                ...
                steps: [
                  ...
                  },
                  {
                    $type:
                      'Tfl.Api.Presentation.Entities.InstructionStep, Tfl.Api.Presentation.Entities',
                    description:
                      'on to Combermere Road, continue for 126 metres',
                    turnDirection: 'RIGHT',
                  ...
                  },
                  {
                    $type:
                      'Tfl.Api.Presentation.Entities.InstructionStep, Tfl.Api.Presentation.Entities',
                    description:
                      'on to Stockwell Road, continue for 106 metres',
                    turnDirection: 'LEFT',
                ...
                steps: [
                  ...
                  },
                  {
                    $type:
                      'Tfl.Api.Presentation.Entities.InstructionStep, Tfl.Api.Presentation.Entities',
                    description:
                      'on to Stockwell Road, continue for 315 metres',
                    turnDirection: 'RIGHT',
                    streetName: 'Stockwell Road',
                    distance: 315,
